fill_joins_map(){
    ...
    join_tests["simple_inner_forcing_order"]="sysbench ${SYSBENCH_LUA}/src/lua/joins/oltp_read_write.lua  --mysql-host=${host} --mysql-port=${port} --mysql-user=${USER} --mysql-password=${PW} --mysql-db=${schemaname} --db-driver=mysql  --skip_trx=off --report-interval=1  --histogram --table_name=${table_name}  --stats_format=csv --db-ps-mode=disable   --rand-type=uniform --simple_inner_forcing_order=1 "
    ...
    join_tests["simple_inner_straight"]="sysbench ${SYSBENCH_LUA}/src/lua/joins/oltp_read_write.lua  --mysql-host=${host} --mysql-port=${port} --mysql-user=${USER} --mysql-password=${PW} --mysql-db=${schemaname} --db-driver=mysql  --skip_trx=off --report-interval=1  --histogram --table_name=${table_name}  --stats_format=csv --db-ps-mode=disable   --rand-type=uniform --simple_inner_straight=1 "
    ...
    join_tests["simple_left_forcing_order"]="sysbench ${SYSBENCH_LUA}/src/lua/joins/oltp_read_write.lua  --mysql-host=${host} --mysql-port=${port} --mysql-user=${USER} --mysql-password=${PW} --mysql-db=${schemaname} --db-driver=mysql  --skip_trx=off --report-interval=1  --histogram --table_name=${table_name}  --stats_format=csv --db-ps-mode=disable   --rand-type=uniform --simple_left_forcing_order=1 "

    join_tests["multi_left_forcing_order"]="sysbench ${SYSBENCH_LUA}/src/lua/joins/oltp_read_write.lua  --mysql-host=${host} --mysql-port=${port} --mysql-user=${USER} --mysql-password=${PW} --mysql-db=${schemaname} --db-driver=mysql  --skip_trx=off --report-interval=1  --histogram --table_name=${table_name}  --stats_format=csv --db-ps-mode=disable   --rand-type=uniform --multi_left_forcing_order=1 "
    ...
    join_tests["simple_right_forcing_order"]="sysbench ${SYSBENCH_LUA}/src/lua/joins/oltp_read_write.lua  --mysql-host=${host} --mysql-port=${port} --mysql-user=${USER} --mysql-password=${PW} --mysql-db=${schemaname} --db-driver=mysql  --skip_trx=off --report-interval=1  --histogram --table_name=${table_name}  --stats_format=csv --db-ps-mode=disable   --rand-type=uniform --simple_right_forcing_order=1 "

    join_tests["multi_right_forcing_order"]="sysbench ${SYSBENCH_LUA}/src/lua/joins/oltp_read_write.lua  --mysql-host=${host} --mysql-port=${port} --mysql-user=${USER} --mysql-password=${PW} --mysql-db=${schemaname} --db-driver=mysql  --skip_trx=off --report-interval=1  --histogram --table_name=${table_name}  --stats_format=csv --db-ps-mode=disable   --rand-type=uniform --multi_right_forcing_order=1 "

    join_tests["simple_right_straight"]="sysbench ${SYSBENCH_LUA}/src/lua/joins/oltp_read_write.lua  --mysql-host=${host} --mysql-port=${port} --mysql-user=${USER} --mysql-password=${PW} --mysql-db=${schemaname} --db-driver=mysql  --skip_trx=off --report-interval=1  --histogram --table_name=${table_name}  --stats_format=csv --db-ps-mode=disable   --rand-type=uniform --simple_right_straight=1 "
